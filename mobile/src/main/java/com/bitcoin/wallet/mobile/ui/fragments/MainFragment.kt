...
import com.bitcoin.wallet.mobile.Constants.TOO_MUCH_BALANCE_THRESHOLD
import com.bitcoin.wallet.mobile.R
import com.bitcoin.wallet.mobile.base.BaseFragment
import com.bitcoin.wallet.mobile.data.PaymentIntent
import com.bitcoin.wallet.mobile.extension.*
import com.bitcoin.wallet.mobile.model.StatsResponse
import com.bitcoin.wallet.mobile.repository.Status
import com.bitcoin.wallet.mobile.repository.WalletRepository
import com.bitcoin.wallet.mobile.service.BlockchainState
import com.bitcoin.wallet.mobile.ui.activitys.*
import com.bitcoin.wallet.mobile.ui.activitys.ScanActivity.Companion.REQUEST_CODE_SCAN
import com.bitcoin.wallet.mobile.ui.adapter.StatsAdapter
import com.bitcoin.wallet.mobile.utils.*
import com.bitcoin.wallet.mobile.utils.CryptoCurrencies.Companion.getTextColor
import com.bitcoin.wallet.mobile.viewmodel.WalletViewModel
...
class MainFragment : BaseFragment(), View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when (item?.itemId) {
            ...
            R.id.menu_report -> {
                //viewModel.showReportIssueDialog.value = Event.simple()
